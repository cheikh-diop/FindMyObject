...
module.exports = "<h1>Out MongoDB is working!</h1>\n\n<ul>\n  <li *ngFor=\"let user of users\">{{ user.description }}</li>\n</ul>"
...
var AppComponent = (function () {
    function AppComponent(_dataService) {
        ...
        this._dataService.getAdverts()
            .subscribe(function (res) { return _this.ad = res; });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__advert_service__ = __webpack_require__("../../../../../src/app/advert.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_7__advert_service__["a" /* AdvertService */]],
