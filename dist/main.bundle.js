...
var SignupComponent = (function () {
    ...
    SignupComponent.prototype.saveUser = function () {
        ...
        this.http.post('/user', this.user)
            .subscribe(function (res) {
            var id = res['_id'];
            _this.router.navigate(['/advert', id]);
        }), function (err) {
            console.log(err);
        };
    };
